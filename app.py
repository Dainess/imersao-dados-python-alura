...
st.set_page_config(
    page_title = "Dasboard de salários da área de Dados",
    page_icon = "📊" ,
    layout="wide"
)
...
# DataFrame filtrado de acordo com as seleções na barra lateral
df_filtrado = df[
...
#print(df_filtrado["cargo"].value_counts().idxmax())
#print(df_filtrado.groupby("cargo")["usd"].count().idxmax())
